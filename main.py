...
@app.route('/search')
def search():
    term_1 = request.args.get('term1', '')
    return render_template('search.html', term1=term_1)
...
if __name__ == '__main__':  # (must be at end of file, any endpoints below it will not be visible)
